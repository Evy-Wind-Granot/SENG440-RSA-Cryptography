...
@ V2_branchless.c:36:     Y0 = (unsigned int)Y & 1U;
	ldr	r3, [r7, #8]	@ Y.0_1, Y
@ V2_branchless.c:36:     Y0 = (unsigned int)Y & 1U;
...
@ V2_branchless.c:39:     for (i = 0; i < m; i++) {
	...
	blt	.L3		@,
@ V2_branchless.c:53:     maskGE = 0U - (unsigned int)(T >= (unsigned int)M);
...
@ V2_branchless.c:54:     T -= maskGE & (unsigned int)M;
	...
	str	r3, [r7, #48]	@ T_30, T
@ V2_branchless.c:55:     maskGE = 0U - (unsigned int)(T >= (unsigned int)M);
...
@ V2_branchless.c:56:     T -= maskGE & (unsigned int)M;
	...
	str	r3, [r7, #48]	@ T_32, T
@ V2_branchless.c:58:     return (int)T;
	ldr	r3, [r7, #48]	@ _33, T
@ V2_branchless.c:59: }
	mov	r0, r3	@, <retval>
	adds	r7, r7, #60	@,,
...
main:
	...
	sub	sp, sp, #88	@,,
	add	r7, sp, #16	@,,
@ V2_branchless.c:73:     const int M = 3233;
	movw	r3, #3233	@ tmp139,
	str	r3, [r7, #64]	@ tmp139, M
@ V2_branchless.c:74:     const int m = 12;
	movs	r3, #12	@ tmp140,
	str	r3, [r7, #60]	@ tmp140, m
@ V2_branchless.c:75:     const long N = 20000000L;
	mov	r3, #11520	@ tmp141,
	movt	r3, 305	@ tmp141,
...
@ V2_branchless.c:84:     for (long i = 0; i < N; i++) {
	b	.L6		@
.L7:
@ V2_branchless.c:85:         int X = (int)((i * 2654435761U) % 4096U);
...
@ V2_branchless.c:85:         int X = (int)((i * 2654435761U) % 4096U);
	...
	str	r3, [r7, #44]	@ X_38, X
@ V2_branchless.c:86:         int Y = (int)((i * 40503U + 1) % 4096U);
